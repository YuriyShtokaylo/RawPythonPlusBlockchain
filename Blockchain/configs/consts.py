...
O4_MSG = '4: Check transactions validity'
O5_MSG = '5: Create wallet'
O6_MSG = '6: Load wallet'
O7_MSG = '7: Save wallet'
H_MSG = 'h: manipulate the chain'
QQ_MSG = 'q: To end program'
...
F_M_MSG = 'Mining failed! Got no wallet?'
II_MSG = 'Input was invalid, please pick a value from the list!'
